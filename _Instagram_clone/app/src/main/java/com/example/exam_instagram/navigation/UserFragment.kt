...
import com.example.exam_instagram.navigation.model.FollowDTO
    ...
    fun requestFollow() {
        ...
        firestore?.runTransaction { transaction ->
            ...
            if (followDTO.followings.containsKey(uid)) {
                // It remove follwing third person when a third person follow me
        ...
        firestore?.runTransaction { transaction ->
            ...
            if (followDTO!!.followers.containsKey(currentUserUid)) {
                //It cancel my follower then I follow a third person
